...
{% hint style="info" %}
Information about supported crypto payment tickers and USDT versions — [Managing domain records](../managing-domains/managing-domain-records.md#crypto-payment-records)
{% endhint %}
